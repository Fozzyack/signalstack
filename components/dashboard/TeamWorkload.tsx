...
export function TeamWorkload({ experts }: { experts: Expert[] }) {
    return (
        <section id="team">
                    ...
                    >
                        ...
                        <div className="min-w-0 flex-1">
                            ...
                            <div className="mt-2 h-1 overflow-hidden rounded-full bg-white/10">
                                <div
                                    className={`h-full rounded-full ${expert.count > 5 ? "w-[88%] bg-amber-200" : expert.count > 3 ? "w-[62%] bg-cyan-300" : "w-[38%] bg-emerald-300"}`}
                                />
                            </div>
                        </div>
                    </div>
